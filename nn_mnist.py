...
dense1 = Layer_Dense(n - 1,10, weight_regularizer_l2=5e-4,bias_regularizer_l2=5e-4)
...
optimizer = Optimizer_SGD(decay=1e-2, learning_rate=0.1, momentum=0.95)
