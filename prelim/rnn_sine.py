...
dense1 = Layer_Dense(1,64, init_weight=0.1)
activation1 = Activation_ReLU()

# dropout layer
dropout1 = Layer_Dropout(0.1)

dense2 = Layer_Dense(64,64, init_weight=0.1)

activation2 = Activation_ReLU()

dense3 = Layer_Dense(64, 1, init_weight=0.1)

activation3 = Activation_Linear()

loss_fxn = Loss_MeanSquaredError()
...
# Add this before the training loop to debug
...
for ep in range(episodes):
    ...
    data_loss = loss_fxn.calculate(activation3.output, y)

    regularization_loss = loss_fxn.reg_loss(dense1) + loss_fxn.reg_loss(dense2) + loss_fxn.reg_loss(dense3)
    ...
    loss_fxn.backward(activation3.output, y)
    activation3.backward(loss_fxn.dinputs)
...
validation_loss = loss_fxn.calculate(activation3.output, y_test)
