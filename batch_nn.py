...
# Add layers
model.add(Layer_Dense(n - 1, 32, weight_regularizer_l2=5e-4, bias_regularizer_l2=5e-4))
model.add(Activation_ReLU())
model.add(Layer_Dense(32, 64, weight_regularizer_l2=5e-4, bias_regularizer_l2=5e-4))
model.add(Activation_ReLU())
model.add(Layer_Dropout(0.2))
model.add(Layer_Dense(64, 32, weight_regularizer_l2=5e-4, bias_regularizer_l2=5e-4))
model.add(Activation_ReLU())
...
model.train(x, y,  
           epochs=1001,
           batch_size=128,  # Use full batch like original
           print_every=100,
...
image = x[2, None].reshape((28, 28)) * 255
plt.gray()
plt.imshow(image, interpolation='nearest')
plt.title(f'True: {y_test[2]}, Predicted: {pred_class[2]}')
plt.show()
