...
loss_fxn = Loss_BinaryCrossEntropy()
...
for ep in range(episodes):
    ...
    data_loss = loss_fxn.calculate(activation2.output, y)

    regularization_loss = loss_fxn.reg_loss(dense1) + loss_fxn.reg_loss(dense2)
    ...
    loss_fxn.backward(activation2.output, y)
    activation2.backward(loss_fxn.dinputs)
...
loss = loss_fxn.calculate(activation2.output, y_test)
